...
class Review(models.Model):
    ...
    # Sub-ratings (1-5)
    taste_rating = models.IntegerField(_("Taste Rating"), null=True, blank=True)
    service_rating = models.IntegerField(_("Service Rating"), null=True, blank=True)
    speed_rating = models.IntegerField(_("Speed Rating"), null=True, blank=True)
    price_rating = models.IntegerField(_("Price Rating"), null=True, blank=True)
