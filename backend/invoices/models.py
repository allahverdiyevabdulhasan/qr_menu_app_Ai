...
def invoice_pdf_upload_path(instance, filename):
    return f"restaurants/{instance.restaurant.slug}/invoices/{filename}"
...
class Invoice(models.Model):
    ...
    pdf_file = models.FileField(_("PDF File"), upload_to=invoice_pdf_upload_path, blank=True, null=True)
