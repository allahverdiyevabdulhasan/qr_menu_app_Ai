...
class Customer(models.Model):
    ...
    # Faz 2: Wallet & Dietary
    wallet_balance = models.DecimalField(_("Wallet Balance"), max_digits=12, decimal_places=2, default=0)
    dietary_preferences = models.JSONField(_("Dietary Preferences"), default=list, blank=True)
