...
class Order(models.Model):
    ...
    customer_profile = models.ForeignKey('customers.Customer', on_delete=models.SET_NULL, null=True, blank=True, related_name='orders')
    ...
    z_report = models.ForeignKey('payments.ZReport', on_delete=models.SET_NULL, null=True, blank=True, related_name='orders')
    courier = models.ForeignKey('staff.Courier', on_delete=models.SET_NULL, null=True, blank=True, related_name='deliveries')
    ...
    # Faz 1 & Faz 2 Additions
    delivery_address = models.ForeignKey('customers.CustomerAddress', on_delete=models.SET_NULL, null=True, blank=True, related_name='deliveries')
...
class OrderItem(models.Model):
    ...
    quantity = models.DecimalField(max_digits=6, decimal_places=2, default=1.00)
