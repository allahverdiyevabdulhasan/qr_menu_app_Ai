...
import { Calendar, Search, ArrowLeft, PlusCircle, RotateCcw, FileText, Truck, CreditCard, Users, ChefHat, TrendingDown, BarChart2, BookOpen, Gift, Clock, DollarSign, PieChart, ShoppingCart, MapPin, Star } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 tracking-tight">Onlayn Rezervasiya</h1>
            <p className="text-gray-500 font-medium text-sm">Masa ayırt</p>
          </div>
        </div>
